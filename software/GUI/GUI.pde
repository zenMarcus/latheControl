...
ControlP5 cp5;
int contrastValue = color(0,0,0);

int sliderValue = 100;
int sliderTicks1 = 100;
int sliderTicks2 = 30;
int displayW = 1366, displayH = 768;
int Hspace = displayW/100, Vspace = displayH/100;
Slider abc;
...
void setup() {
  ...
  PFont pfont = createFont("KozGoPro-ExtraLight.otf",14,true); // use true/false for smooth/no-smooth
  ...
  cp5.addSlider("Contrast")
     .setPosition(11*Hspace,displayH-8*Vspace)
     .setSize(displayW/4,displayH/20)
     .setRange(0,255)
     .setValue(50)
     .getCaptionLabel()
     .setFont(font)
  ...
  cp5.addSlider("Brightness")
     .setPosition(11* Hspace,displayH-15*Vspace)
     .setSize(displayW/4,displayH/20)
     .setRange(0,255)
     .setValue(128)
     .getCaptionLabel()
...
void draw() {
  ...
  */
  //camera placeholder
  fill(contrastValue);
  rect(Hspace, Vspace, 640, 640);
}

void Contrast(float theColor) {
  contrastValue = color(theColor);
